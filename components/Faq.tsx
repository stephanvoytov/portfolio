        ...
        <div className="mx-auto mt-12 max-w-3xl space-y-3">
          {faqs.map((f, i) => (
            <Reveal key={f.q} delay={i * 0.04}>
              <details className="group rounded-2xl border border-line bg-white shadow-sm transition-all duration-200 open:border-black open:shadow-[4px_4px_0_0_#c9a227]">
