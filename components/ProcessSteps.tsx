...
const steps = [
  ...
  },
  {
    ...
    desc: "Собираю структуру сайта: какие страницы нужны, что на них разместить, как 연결ить. Рисую прототип — вы видите будущий сайт ещё до дизайна. На этом этапе корректируем объём и финализируем стоимость.",
  },
  {
    num: "03",
