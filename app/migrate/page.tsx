...
const basePlans = [
  ...
  },
  {
    ...
    price: "от 65 000 ₽",
    days: "10–15 дней",
    desc: "Полноценный магазин с оплатой и доставкой: продажи идут на сайте, а склад не уходит в минус, пока вы торгуете на площадке.",
    items: [
      "Каталог до 300 товаров, перенос карточек с WB/Ozon",
      "Синхронизация остатков при параллельной торговле",
