...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Для этого есть шаг «Клиенты и адаптация»: QR-коды в своих заказах, вкладыши, соцсети, накопительные скидки. Каждая посылка превращается в возможность привести покупателя на ваш сайт.",
      },
    },
    {
      "@type": "Question",
...
const noFit = [
  ...
  "До ~200 заказов в месяц: реклама и подрядчик на маркетинг дороже разницы в комиссии",
