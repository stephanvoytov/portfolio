...
const plans = [
  ...
  },
  {
    name: "Магазин",
    price: "от 50 000 ₽",
    desc: "2–3 недели. Полноценный магазин со своей корзиной и оплатой: переносим карточки при запуске, дальше товарами управляете сами.",
    items: [
  ...
  },
  {
    name: "Полный переход",
    price: "от 80 000 ₽",
    desc: "4–6 недель. Сайт становится основным каналом: цены на нём ниже, чем на площадках, и клиенты переезжают к вам по шагам.",
    items: [
      "Всё из «Магазина», без лимита товаров",
      "Синхронизация остатков, пока продаёте параллельно с МП",
      "Вкладыши с QR в посылки — клиенты переезжают на сайт",
      "Реклама и SEO на 2 месяца, оферта и 152-ФЗ",
