...
const problems = [
  {
    ...
    desc: "За «25% комиссии» прячутся логистика, хранение, реклама, эквайринг и возвраты. Реальная нагрузка — 35–55% с продажи. Платье за 3 000 ₽ на Ozon: 46% комиссия, плюс логистика и реклама — уходит 65% выручки.",
  },
  {
    title: "Комиссии растут — вы не можете это остановить",
    desc: "С 7 июля 2026 Wildberries переписал таблицу комиссий: рост в 98% категорий, одежда — до 43,5%. Ozon повышает с 28 августа 2026 — одежда до 55%. Мораторий на рост закончился: маржа на площадке — чужой прогноз, а не ваш план.",
  },
  {
    title: "Штрафы и списания — с вашего счёта",
    desc: "Просрочили отгрузку — штраф 50% цены товара. Упаковка — 500–1 500 ₽, брак — 2 000–5 000 ₽, опоздание поставки — 1 000–3 000 ₽ в день. «Потерянные» посылки списываются автоматически, без разбирательств.",
  },
  {
    title: "Возвраты съедают маржу",
    desc: "В одежде возвращается 20–40% заказов — каждый возврат это логистика и переработка за ваш счёт. На своём сайте возвратов единицы: клиент видит реальные фото, размеры и отзывы, а не обезличенную карточку.",
  },
  {
    title: "Клиент не ваш",
    desc: "Покупатель приходит на площадку, а не к вам: контактов нет, повторная продажа снова платная — через рекламу внутри маркетплейса. Каждая продажа на площадке — аренда клиента, а не покупка.",
  },
  {
    title: "Правила меняет площадка",
    desc: "Наценки за продажи не в своём регионе — до 12% на Ozon. Объединение ценовых диапазонов, новые алгоритмы выдачи — ваш бизнес перестраивается по решениям чужой платформы, когда угодно и без спроса.",
  },
];
