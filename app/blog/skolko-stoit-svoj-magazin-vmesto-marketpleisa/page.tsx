      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <ul className={ul}>
            ...
            <Li>
              <b>Магазин — от 40 000 ₽.</b> Полноценный магазин: каталог, корзина, онлайн-оплата,
              доставка. Синхронизация остатков с площадкой — +10 000 ₽.
            </Li>
            <Li>
              <b>Сложный магазин — от 80 000 ₽.</b> Магазин плюс первый контур перевода клиентов
          ...
          <div className="mt-8 grid gap-4">
            {[
              ...
              },
              {
                ...
                price: "от 80 000 ₽",
                desc: "Магазин плюс стратегия перевода клиентов с площадок: QR-воронка, сбор базы, реклама, интеграции.",
                days: "около 3 недель",
              },
            ].map((t) => (
              <div
